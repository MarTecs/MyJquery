 ...
 * 
 * @see com.pojo.Yuangong
 * @author MyEclipse Persistence Tools
 */

public class YuangongDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(YuangongDAO.class);
	// property constants
	public static final String _YNAME = "YName";
	...
	public List findByYName(Object YName) {
		return findByProperty(_YNAME, YName);
	}
	...
	public static YuangongDAO getFromApplicationContext(ApplicationContext ctx) {
		return (YuangongDAO) ctx.getBean("YuangongDAO");
	}
}